            ...
            >
                ...
                >
                    <Animated.Text
                        ...
                        entering={BounceInDown.duration(1400).delay(800)}
                    >
                        Login
                    </Animated.Text>
                    <Animated.View
                        entering={BounceInLeft.duration(1600).delay(1000)}
                    >
                        <Controller
                            control={control}
                            rules={{
                    ...
                    <Animated.View
                        className={'mb-4'}
                        entering={BounceInRight.duration(1800).delay(1200)}
                    >
                        <Controller
                            control={control}
                            rules={{
                    ...
                    {/* Forgot Password */}
                    <Touchable
                        entering={BounceInLeft.duration(2000).delay(1400)}
                    ...
                    {/* Login Button */}
                    <Animated.View entering={BounceInRight.duration(2200).delay(1600)}>
                        <CustomButton
                            title="Login"
                            disabled={!isValid}
                    ...
                    <Animated.View entering={BounceInLeft.duration(2400).delay(1800)}>
                        <CustomButton
                    ...
                    <Animated.View
                        entering={BounceInRight.duration(2600).delay(2000)}
